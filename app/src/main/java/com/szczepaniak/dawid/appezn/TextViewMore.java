...
public class TextViewMore extends android.support.v7.widget.AppCompatTextView {
    ...
    private TextViewMore.ReadMoreClickableSpan viewMoreSpan;
    ...
    public TextViewMore(Context context, AttributeSet attrs) {
        ...
        typedArray.recycle();
        viewMoreSpan = new TextViewMore.ReadMoreClickableSpan();
